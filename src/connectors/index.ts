...
const ETHEREUM_MAINNET_RPC = process.env.REACT_APP_ETHEREUM_MAINNET_RPC
...
export const NETWORK_URLS: { [key in SupportedChainId]: string } = {
  [SupportedChainId.MAINNET]: ETHEREUM_MAINNET_RPC ? ETHEREUM_MAINNET_RPC : `https://eth.llamarpc.com`,
  [SupportedChainId.RINKEBY]: `https://rinkeby.infura.io/v3/${INFURA_KEY}`,
  [SupportedChainId.ROPSTEN]: `https://ropsten.infura.io/v3/${INFURA_KEY}`,
  [SupportedChainId.GOERLI]: `https://eth-goerli.public.blastapi.io`,
