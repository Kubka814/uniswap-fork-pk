...
export default function Swap({ history }: RouteComponentProps) {
  ...
  const { state: signatureState, signatureData } = useERC20PermitFromTrade(trade, allowedSlippage)
  ...
  }, [approveCallback, toggledVersion, trade?.inputAmount.currency.symbol])
